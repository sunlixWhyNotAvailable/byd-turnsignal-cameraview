...
public final class DirectCameraSourceHubStatsTest {
    ...
    public void reportsAndResetsFiveSecondPerSourceWindow() {
        ...
        assertNull(second.record(
                5_000_000_000L, 2_000_000_000L,
                1L, 1L, 1L, 1L, 1L, 2L, 1, 1L,
                1, 100L, 10, 10,
                new int[]{10}, new int[]{10}, 1, 1920, 990));
        assertNull(first.record(
                5_100_000_000L, 1_066_666_666L,
                1L, 1L, 1L, 1L, 1L, 2L, 1, 1L,
                1, 100L, 10, 10,
                new int[]{10}, new int[]{10}, 1, 1920, 1300));
    }
    ...
    @Test
    public void vendorTimestampClockNeverPublishesDerivedAgeOrRate() throws Exception {
        String source = new String(java.nio.file.Files.readAllBytes(java.nio.file.Paths.get(
                "src/main/java/com/byd/extend/CameraHelperMain.java")),
                java.nio.charset.StandardCharsets.UTF_8);
        assertTrue(source.contains("\"producer_timestamp_clock\", \"unverified\""));
        assertFalse(source.contains("\"source_frame_age_"));
        assertFalse(source.contains("\"producer_timestamp_fps\""));
        assertFalse(source.contains("\"producer_timestamp_delta_"));
        assertTrue(source.contains("\"callback_gap_avg_ms\""));
        assertTrue(source.contains("\"swap_wait_avg_ms\""));
    }
